...
const formSchema = z.object({
    ...
    businessLicenseNumber: z.string().min(1, {
        message: "Business License must be included",
    }),
    address: z.string().min(1, {
        message: "Address must be included",
    }),
    contactNumber: z.string().min(1, {
        message: "Contact Number must be included",
    }),
    website: z.string().min(1, {
        message: "Website must be included",
    }),
    servicesOffered: z.string().min(1, "Services Offered Must be included"),
    establishedYear: z.string().min(1, {
        message: "Established Year must be included",
    }),
    ...
    taxIdentificationNumber: z.string().min(1, {
        message: "Tax Identification Number must be included",
    }),
});
